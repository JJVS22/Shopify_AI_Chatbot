...
const PLACEMENT_PROMPTS = {
  ...
  wearing:
    "Identify the clothing/product from the second image. Dress the person in the first image with the clothing/product from the second image. Keep the person's face, body pose, and background. Realistic fabric fit and lighting. If the product is not wearable, place it naturally in the scene. Analyze the size of the product, do not apply products based on person portion but the size of the product, keep in mind there are different sizes of products, choose a size of the product for the person in a natural way. Do not add any changes to the product itself, keep the product as it is. Do not add any other products or accessories to the person, only use the product from the second image.",
  pairing:
